...
<html lang="fr">
  ...
  <body>
    <header>
      <div class="connexion">
        <a href="../index.php"><button class="btn btn-outline-danger" type="button" name="button">Déconnexion</button></a>
      </div>
        <div class="search">
        ...
        <div class="search-member">
            <form action="searchmember.php" method="post">
                <input type="text" name="name" placeholder="Rechercher un membre.">
                <input type="submit" value="Rechercher" class="btn btn-success">
                <p style="color:white">Ex: Genre un membre connard tu sais pas ce que c'est ? </p>
            </form>
        </div>
